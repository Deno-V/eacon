...
outputfile = "../testdata/dev_vicunaextract.json"
if fs:
    outputfile = "../testdata/fsdev_vicunaextract.json"
...
Task: Given the following input and keywords, provide a concise and factual summary based on the examples above. Exclude any information not directly related to the keywords.
