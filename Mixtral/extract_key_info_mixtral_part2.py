...
inputfile = "../testdata/dev_mixtralextract.json"
outputfile = "../testdata/dev_mixtralextract_filtered.json"
if fs:
    inputfile = "../testdata/fsdev_mixtralextract.json"
    outputfile = "../testdata/fsdev_mixtralextract_filtered.json"
